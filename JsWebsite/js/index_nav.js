...
function openNav(menu) {
  ...
  $('allKPI').children("img").attr('src', './DEMO_IMG/bulletnoselect.png');
  $('myKPI').children("img").attr('src', './DEMO_IMG/bulletnoselect.png');
  $('warningKPI').children("img").attr('src', './DEMO_IMG/bulletnoselect.png');

  if(nav == undefined || nav == 'allKPI'){
    $('allKPI').children("img").attr('src', './DEMO_IMG/bulletselect.png');
  }
  else if(nav == 'myKPI'){
    $('myKPI').children("img").attr('src', './DEMO_IMG/bulletselect.png');
  }
  else if(nav == 'warningKPI'){
    $('warningKPI').children("img").attr('src', './DEMO_IMG/bulletselect.png');
  }
}
...
function active(menu){
  ...
  if(menu == 'dash' || menu == undefined){
    ...
    $('.dropdown-container').html(`<li><a href="./BrandSales/BrandSales.html?nav=sales" class="active"><img src="./DEMO_IMG/bulletnoselect.png">브랜드별 매출</a></li>
                        <li><a href="./MapChartWeb/webServer.html"><img src="./DEMO_IMG/bulletnoselect.png">지역별 매출</a></li>`)
  }
  else if(menu == 'inventory'){
    $('#inventory').addClass('active');
